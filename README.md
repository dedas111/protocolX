...
**funnelAmount** tells the compute nodes, how many funnels are active. This is important for deciding which funnel to use. Remember, funnels have to use the normal ID parameter and start with ID 0!