...
func createStaticTestPacketWithPortForIndividual(t *testing.T, payload string, ip string, port string) *sphinx.SphinxPacket {
	...
	// create packet
	path := config.E2EPath{IngressProvider: computeConfig, Mixes: []config.MixConfig{computeConfig, computeConfig, computeConfig, computeConfig}, EgressProvider: computeConfig, Recipient: clientConfig}
